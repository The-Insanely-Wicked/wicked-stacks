...
export const POSTS: Post[] = [
  {
    slug: "profit-is-an-opinion-cash-is-a-fact",
    title: "Profit Is an Opinion. Cash Is a Fact.",
    date: "2026-08-27",
    category: "Business",
    excerpt:
      "A million in accounts receivable and nothing in the bank doesn't make you a millionaire. It makes you someone who is about to be evicted.",
    body: [
      "Profitable companies go bankrupt every single day. It is the most uncomfortable arithmetic in business and the one most founders ignore right up until they are looking at an empty account and a final notice from their landlord.",
      "We are taught to worship the bottom line of a profit and loss statement. But a P&L is an opinion. Cash is a fact.",
      "If you have a million dollars in accounts receivable and nothing in the bank, you are not a millionaire. You are a person who is about to be evicted.",
      "## The butcher always gets paid",
      "Whether you made a sale this morning or not, the butcher is at the door with his hand out. Your rent. Your payroll. Your hosting bill. Your taxes.",
      "He does not care about your vision. He is not interested in your three-year projections or your disruptive culture. He wants his money now, and if you cannot pay him, the vision is over — regardless of what your accountant says you earned last quarter.",
      "## Where the illusion comes from",
      "Most founders live in a mild state of accounting-induced delusion. They see a positive number at the bottom of the monthly report and assume things are working.",
      "But profit under accrual accounting is a ghost. It is a representation of value that may or may not exist anywhere in the physical world yet. You booked the revenue when you invoiced. The money has not moved.",
      "You can be profitable on paper for years while your bank balance quietly bleeds toward zero, and the reason is almost always the same: growth is expensive. Scaling requires spending on inventory, people and marketing before any of it comes back. If the speed at which cash leaves exceeds the speed at which it arrives, the gap widens every month you succeed.",
      "It does not matter how good the product is. It does not matter that you have five stars everywhere. You end up in the strange position of being a successful business owner who cannot afford a sandwich.",
      "## The number that actually tells you the truth",
      "There is a simple test, and almost nobody runs it.",
      "Take last month's profit from your P&L. Then take how much your bank balance actually changed over the same month. Put the two numbers side by side.",
      "They will not match. They are never supposed to match exactly. But the size of the gap, and the direction of it, is the single most useful thing you can know about your business — and if you cannot explain the difference in one sentence, you do not yet understand how your own company works.",
      "Usually the explanation is one of three things. You are being paid slower than you are paying out. You are buying inventory or capacity ahead of the revenue it produces. Or you are servicing debt that never appears in the profit line at all.",
      "All three are survivable. None of them are survivable if you do not know which one is happening.",
      "## Solvency is the whole game",
      "There is a version of business advice that treats cash management as bookkeeping — the boring part you delegate once you can afford to.",
      "It is the opposite. Every strategic option you have is downstream of how long you can keep the lights on. A company with six months of cash can walk away from a bad contract, wait out a slow quarter, and hire before the revenue arrives. A company with three weeks of cash takes whatever it is offered, at whatever terms, forever.",
      "That is not a difference in ambition. It is a difference in solvency, and it decides what kind of company you are allowed to be.",
      "In the end business is largely a game of staying solvent long enough to get lucky. The founders who last are not the ones who were most talented. They are the ones who were still trading when their moment arrived.",
      "## Do this one thing this week",
      "Pull last month's profit figure and last month's actual change in bank balance. Write both numbers on the same piece of paper.",
      "Then write one sentence explaining the difference. Not a spreadsheet — one sentence, in plain words, that you would be comfortable saying out loud to someone who knows what they are talking about.",
      "If you cannot write that sentence today, that is the most important thing you learned this week, and it is worth more than whatever you had planned to do instead.",
