...
// covers are regenerated by hand, not during a build, so the site does not
// carry a browser download for it. Install it when you need it:
//   npm install --no-save playwright
// If your chromium lives somewhere non-standard, point at it with the
// CHROMIUM_PATH env var, which the launch call below already honours.
